...
//MXL_STATUS_E MxL_HYDRA_DevInitilization(MXL_HYDRA_DEVICE_E devSku, MXL_BOOL_E forceFirmwareDownload,MXL_HYDRA_TS_MUX_TYPE_E tsMuxType, MXL_HYDRA_MPEG_MODE_E tsInterfaceMode, UINT8 maxTsInterfaceClkRate);
